    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while ((readLine = b.readLine()) != null) {
                ...
                try{
                    crower.getAmazonProds(quaries[0], 2, Double.parseDouble(quaries[1]), Integer.parseInt(quaries[2]), Integer.parseInt(quaries[3]), map);
                } catch (Exception e) {
        ...
        try {
            mapper.writeValue(new File("C:\\Users\\Administrator\\IdeaProjects\\SearchAdPlatform\\AdsPage2.json"), map);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
